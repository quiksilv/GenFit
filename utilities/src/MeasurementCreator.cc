...
std::vector<genfit::AbsMeasurement*> MeasurementCreator::create(eMeasurementType type, TVector3 pos, TMatrixDSym cov) {
...
double umin = -30.1; //10.1 20./60 ?
double umax = 30.1;
double vmin = -30.1;
double vmax =  30.1;
genfit::SharedPlanePtr plane(new genfit::DetPlane(point, planeNorm.Cross(z), (planeNorm.Cross(z)).Cross(planeNorm),new genfit:: RectangularFinitePlane(umin,umax,vmin,vmax) ));
